...
/**
 * Created by ETHKWannipa on 10/16/2015.
 */
public class MyAdapter extends BaseAdapter{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        //Setup For Title1
        TextView title1TextView = (TextView) objView1.findViewById(R.id.txtTittle1);
        title1TextView.setText(title1Strings[i]);

        //Setup For Title2
        TextView title2TextView = (TextView) objView1.findViewById(R.id.txtTrttle2);
