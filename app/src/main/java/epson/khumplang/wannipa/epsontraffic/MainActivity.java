package epson.khumplang.wannipa.epsontraffic;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void creatListView() {
        ...
        MyAdapter objMyAdapter = new MyAdapter(MainActivity.this, iconInts, title1Strings, title1Strings);
    ...
    private void buttonController() {
        ...
        aboutMeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Sound effect
                MediaPlayer buttonMediaPlayer = MediaPlayer.create(getBaseContext(), R.raw.bird);
                buttonMediaPlayer.start();

                //Intent to WebView
                Intent objIntent = new Intent(Intent.ACTION_VIEW);
                objIntent.setData(Uri.parse("https://youtu.be/tkXOKkxc0BA"));
